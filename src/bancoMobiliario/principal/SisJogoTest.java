...
class SisJogoTest {
	...
	private ArrayList<Propriedade> tabuleiro = null;
	private ArrayList<String> cores = null;
	private ArrayList<Jogador> jogadores = null;
	private SisJogo sis = null;
	...
	void setUp() throws Exception {
		tabuleiro = new ArrayList<Propriedade>();
		cores = new ArrayList<String>();
		jogadores = new ArrayList<Jogador>();
		sis = new SisJogo();
		jogadores.add(new Jogador("marcos","vermelho")); 
	...
	@Test
	void testGravaJogadorComCorJaEscolhida() throws JogadorComCorEscolhidaExisteException, CorInvalidaException {
		sis.gravaJogador(new Jogador("a","vermelho"));
