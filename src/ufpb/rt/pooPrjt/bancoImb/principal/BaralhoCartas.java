 ...
 */
	public BaralhoCartas() {
		...
		this.baralho.add(new PagamentoReves("O dia do seu casamento chegou, receba os presentes - 50 de cada jogador",50));//2(Ainda não implementado)
		...
		this.baralho.add(new PagamentoReves("Jogue os dados novamente",0));//12 (Ainda não implementado)
		...
		this.baralho.add(new PagamentoReves("Sorte se tirou o número par da soma dos dados e revés caso contrário",0));//24(Ainda não implementado)
